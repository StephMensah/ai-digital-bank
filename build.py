...
# The downloadable copy of the pitch, regenerated by scripts/make-pitch-pdf.py.
if (src/"pitch.pdf").exists():
    (public/"pitch.pdf").write_bytes((src/"pitch.pdf").read_bytes())
    print("pitch.pdf                  copied")
